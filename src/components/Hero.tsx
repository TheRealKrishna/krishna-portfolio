      ...
      >
        ...
        <div className="relative grid aspect-square w-[min(20rem,82vw)] place-items-center sm:w-[26rem]">
          ...
          <motion.div
            ...
            className="absolute bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-white/10 bg-base-2/90 px-4 py-2 text-xs font-semibold shadow-glow backdrop-blur-md"
          >
